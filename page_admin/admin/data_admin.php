...
<div class="container">
  <div class="top-action-bar">
    <div>
      <h3> Data Admin</h3>
      <p>Lihat dan kelola semua admin di sistem.</p>
    </div>
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($sql)) {
            ...
            echo "<tr>
              <td>{$no}</td>
                 <td>
                <img src='upload/admin/{$foto}' alt='Foto Admin' style='width:50px; height:50px; object-fit:cover; border-radius:50%; border:2px solid #ddd;'>
              </td>
                <td>{$row['username']}</td>
                ...
                <td class='aksi-btn'>
                <a href='index_admin.php?page_admin=admin/edit_admin&id={$row['id_admin']}' class='btn-edit'>Edit</a>
                  <a href='index_admin.php?page_admin=admin/hapus_admin&id={$row['id_admin']}' class='btn-hapus' onclick='return confirm(\"Yakin ingin menghapus pelanggan ini?\")'>Hapus</a>
                </td>
              </tr>";
              $no++;
            }
